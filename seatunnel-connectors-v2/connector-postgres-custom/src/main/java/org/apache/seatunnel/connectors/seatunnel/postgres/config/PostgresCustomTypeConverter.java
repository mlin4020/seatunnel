...
package org.apache.seatunnel.connectors.seatunnel.postgres.config;
...
public class PostgresCustomTypeConverter implements TypeConverter<BasicTypeDefine> {
    ...
    // Add support for varchar2 type
    public static final String PG_VARCHAR2 = "varchar2";
    ...
    public static final PostgresCustomTypeConverter INSTANCE = new PostgresCustomTypeConverter();
    ...
    public Column convert(BasicTypeDefine typeDefine) {
        ...
        switch (pgDataType) {
            ...
            case PG_VARCHAR2: // Add support for varchar2 type
                builder.dataType(BasicType.STRING_TYPE);
                if (typeDefine.getLength() == null || typeDefine.getLength() <= 0) {
                    builder.sourceType(pgDataType);
                } else {
